...
/// </summary>
[CreateAssetMenu(fileName = "InfosDuJoueur", menuName = "Infos du joueur")] //consigne de creation du menu de creation de l'asset
public class InfosJoueur : ScriptableObject //preciser que c'est un S.O.
{
    ...
    [SerializeField] private string _nomIni = "Prénom"; //nom par defaut
    ...
    [Header("Valeur en cours")] //Entete de section pour les Valeurs en cours (pendant la partie)
